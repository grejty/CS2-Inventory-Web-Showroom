...
SECRET_KEY = 'django-insecure-generate-a-new-key-for-production'
...
INSTALLED_APPS = [
    ...
    'inventory',  # Our CS2 inventory app
]
...
ROOT_URLCONF = 'cs2_showroom.urls'
...
WSGI_APPLICATION = 'cs2_showroom.wsgi.application'
